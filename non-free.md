...
- [BrowserStack Automate TurboScale](https://www.browserstack.com/automate-turboscale) - Scalable and Fast Browser Automation Grid on your Cloud (AWS, GCP and Azure) supporting Selenium and Playwright. `⊘ Proprietary` `Docker`
